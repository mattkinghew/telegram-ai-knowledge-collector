...
| `tools/p1_5_gemini_live_smoke.py` | LIVE ACCEPTANCE PREPARATION | Fixed fictional four-mode/failure/manual-retry smoke with sanitized evidence; not executed externally |
