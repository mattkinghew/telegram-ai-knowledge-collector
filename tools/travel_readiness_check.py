...
REQUIRED_FILES = (
    ...
    "docs/P1_5_BACKUP_RESTORE_DRILL.md",
...
MANUAL_ONLY_PENDING = (
    ...
    "Remotely Save",
    "Make/Gemini",
    "Remaining P1.4 device scenarios (Backend OFF USER_REPORTED_DEVICE_PASS)",
    "P1.5 backend Shortcut device acceptance",
    "P1.5 live Gemini acceptance",
    "P1.5 staging Mock and persistence acceptance",
    "P1.5 staging backup/restore acceptance",
